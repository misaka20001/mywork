...
static struct file_operations s3c24xx_leds_fops = {
    .owner  =   THIS_MODULE,     /* this is a macro，point to __this_module variable created in compiling modules automaticly */
...
static int __init s3c24xx_leds_init(void)
{
     ...
     */
    ret = register_chrdev(LED_MAJOR, DEVICE_NAME, &s3c24xx_leds_fops);   /* defined in linux/fs.h */
    if (ret < 0) {
...
/* 描述驱动程序的一些信息，不是必须的 */
MODULE_AUTHOR("0xdeadbeef");             // 驱动程序的作者
